...
<head>
    ...
    <!-- Title Page-->
    <title>Pelazobit - Transactions</title>
      <!-- Favicons -->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h2 class="title-1">All Transactions</h2>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if($tran->status == 'pending')
                                                        <p class="badge badge-warning text-dark">{{$tran->status}}</p>

                                                        @elseif($tran->status == 'cancel')
                                                        <p class="badge badge-danger text-light">Declined</p>

                                                        @elseif($tran->status == 'completed')
                                                        <p class="badge badge-success text-light">{{$tran->status}}</p>

                                                    @endif
                                                </td>
                                            
                                                <td><img src="uploads/{{$tran->screenshot}}" alt=""style="width:100px;height:100px;"></td>
                                                <td>

                                                <form action="{{route('admin.transaction.delete',$tran->id)}}"method="POST">
                                                    @csrf 
                                                
                                                    <a href="uploads/{{$tran->screenshot}}"class="btn btn-primary btn-sm text-light">View Image</a>
                                                    <a href="{{route('admin.transaction.cancel',$tran->id)}}"class="btn btn-sm btn-warning text-dark">Cancel</a>

                                                   

                                                    <a href="{{route('admin.transaction.complete',$tran->id)}}"class="btn btn-sm"style="color:white;background:#463F92;">Completed</a>
