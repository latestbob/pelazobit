...
<head>
    ...
    <!-- Title Page-->
    <title>Pelazobit - Admin Dashboard</title>
      <!-- Favicons -->
            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="has-sub">
                            <a class="js-arrow" href="{{route('admin.transaction')}}">
                            <i class="fas fa-chart-bar" aria-hidden="true"></i> Transactions</a>
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="col-lg-6">
                            <coin-ponent fixed-token fixed-fiat token="BTC"></coin-ponent>
                        </div>


                        <div class="col-lg-6">
                            <coin-ponent fixed-token fixed-fiat token="ETH"></coin-ponent>
                        </div>
