                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h2 class="title-1">Pay {{$customer->name}}</h2>
                     ...
                     <div class="row">
                       ...
                       <div class="col-md-8 card m-auto py-2 px-2">
                            
                            <p class="text-center p-2"style="background:#463F92;color:white;font-weight:bold;">Make the Withdrawal amount to the below account </p>

                            <form action="{{route('admin.pay.paystack')}}"method="POST">
                                @csrf 

                                <div class="form-group">
                                    <label for="">Bank Name</label>

                                    <input type="text"value="{{$customer->bank}}"class="form-control"disabled>
                                </div>

                                <div class="form-group">
                                    <label for="">Account Number</label>
                                    <input type="text"value="{{$customer->accountnumber}}"class="form-control"disabled>
                                </div>

                                <div class="form-group">
                                    <label for="">Account Name</label>
                                    <input type="text"value="{{$customer->accountname}}"class="form-control"disabled>
                                </div>
