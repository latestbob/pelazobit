...
<head>
    ...
    <!-- Title Page-->
    <title>Pelazobit- Sell Giftcards</title>
      <!-- Favicons -->
    ...
    <div class="page-wrapper">
        ...
        <div class="page-container">
           ...
           <div class="main-content">
                ...
                <div class="row py-3"style="height: 70px;background:#463F92;">
                        <h2 class="font-weight-bold text-light px-3">{{$card->name}}</h2>
                ...
                <div class="row">
                    ...
                    @if ($errors->any())
                        ...
                        <form action="{{route('btctrans')}}"method="POST"enctype="multipart/form-data">
                            ...
                            <input type="hidden"id="name"name="value"value="{{$card->name}}"required>

                            <select name="variant" id="variant"class="form-control mb-3"style="height:50px;border-radius:20px;"required>
                            ...
                            <select name="country" id="country"class="form-control mb-3"style="height:50px;border-radius:20px;"required>
                            ...
                            <select name="domination" id="domination"class="form-control mb-3"style="height:50px;border-radius:20px;"required>
                                <option value="">Domination</option>

                                @foreach($domination as $d)

                                    <option value="{{$d->domination}}">{{$d->domination}}</option>
                                @endforeach
                            </select>


                            <input type="number"id="usdvalue"name="cardvalue"placeholder="Enter Value of Card in USD"class="form-control py-2"style="height:50px;border-radius:20px;"required>



                                <br>

                                <div class="card rounded notvisible py-3 maindisplay"style="background:#463F92;">

                                    <h3 class="text-center"id="total"style="color:white"></h3>
                                
                                </div>

                                <div class="card bg-danger notvisible rounded e py-3 errordisplay"style="">

                                <h3 class="text-center"id="total"style="color:white">Card not Found </h3>

                                </div>


                                <div id="submitting"class="notvisible">
                                <div class="form-group">
                                    <label for=""style="color:black;">Upload Gift Card</label>
...
let inputvalue= document.getElementById('usdvalue').value

if(inputvalue == ''){
    $('.maindisplay').removeClass('visible');
    $('.maindisplay').addClass('notvisible');
    $('#submitting').addClass('notvisible');

    $('.errordisplay').removeClass('visible');
    $('.errordisplay').addClass('notvisible');
...
else if(country==''||domination==''||variant==''){
    
    $('.errordisplay').removeClass('visible');
    $('.errordisplay').addClass('notvisible');
    alert('Please the necessary Select fields')
}

else{
    $('.maindisplay').removeClass('notvisible');
    $('.maindisplay').addClass('visible');
    ...
    $.ajax({
                    ...
                    success: function(result) {
                        ...
                        if(result['status'] == 'true'){
                            ...
                            $('#total').html('You will  Get <br> N ' + result['amount'])
                            $('#submitting').removeClass('notvisible');

                            $('#submitting').addClass('visible');
                            ...
                            $('.errordisplay').removeClass('notvisible');
