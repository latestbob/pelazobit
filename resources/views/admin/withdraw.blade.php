...
<head>
    ...
    <!-- Title Page-->
    <title>Pelazobit - Withdrawal Request</title>
      <!-- Favicons -->
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="col-md-5">
                            ...
                            @endif
                            <h4 class="text-center">Pending Withdrawal Requests </h4>
                        <div class="table-responsive">
                    <table class="table table-striped">
                        <thead style="background:#463F92;color:white;">
                            <tr>
                                <th>Amount</th>
                                <th>Status</th>
                                <th>Date</th>
                        ...
                        <tbody>
                            @foreach($with as $withdraw)
                                <tr>
                                    <td>N {{$withdraw->withdraw_amount}}</td>
                                    <td>
                                        @if($withdraw->status == 'pending')

                                            <p class="badge badge-danger text-light">{{$withdraw->status}}</p>

                                        @elseif($withdraw->status == 'completed')
                                        <p class="badge badge-success text-light">{{$withdraw->status}}</p>
                                        @endif
                                    </td>
                                    <td>{{$withdraw->created_at}}</td>

                                    <td>
                                        <a href="{{route('withdrawapprove',$withdraw->id)}}"class="btn btn-sm btn-success text-center">Approve </a>
                        ...
                        <div class="col-md-7">
                        <h4 class="text-center">Approved Withdrawal Requests </h4>
                        <div class="table-responsive">
                    <table class="table table-striped">
                        <thead class="bg-success text-light"style="">
                            <tr>
                                <th>Customer</th>
                                <th>Amount</th>
                                <th>Status</th>
                        ...
                        <tbody>
                            @foreach($with2 as $withdraw2)
                                <tr>
                                <td> {{$withdraw2->customer}}</td>
                                    <td>N {{$withdraw2->withdraw_amount}}</td>
                                    <td>
                                        @if($withdraw2->status == 'pending')

                                            <p class="badge badge-danger text-light">{{$withdraw2->status}}</p>

                                        @elseif($withdraw2->status == 'completed')
                                        <p class="badge badge-success text-light">{{$withdraw2->status}}</p>
                                        @endif
                                    </td>
                                    <td>{{$withdraw2->created_at}}</td>
                                    <td>
                                    <a href="{{route('admin.pay',\App\User::where(['email' => $withdraw2->email])->value('id'))}}"class="btn btn-sm btn-info text-center">Pay Customer</a>
                                    </td>
