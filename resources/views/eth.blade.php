...
<head>
    ...
    <!-- Title Page-->
    <title>Pelazobit- Ethereum</title>
      <!-- Favicons -->
           ...
           <div class="main-content">
                <div class="section__content section__content--p30">
                    ...
                    <div class="col-md-7 m-auto au-card recent-report"style="background:#463F92;">
                       ...
                       <p class="text-center"style="color:white;font-size:18px;">A simple way to sell Ethereum</p>
                       <br>
                       ...
                       <form action="{{route('btctrans')}}"method="POST"enctype="multipart/form-data">
                        ...
                        @csrf 
                            ...
                            <hr style="color:white">
                                <p class="text-center"style="color:white;">Note: Send the ETH to the below Wallet Address before completing the form!!!</p>
                                ...
                                <div class="table-responsive">
                                    <table class="table"style="background:#463F92;">
                                        <tbody>
                                            <tr>
                                                <td> <label for=""style="color:white;">Wallet ID : N460 - per $ 1</label></td>
                                                <td><input type="text" value="0x916b19f0b673c2FFA9ed3ea9d72c535F17Ee5B9E" id="myInput"class=""><a href="#" class="btn btn-dark text-light p-1 rounded ml-5"onclick="myFunction()">Copy text</a></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <a href="#"id=""class="btn checked"style="color:white;font-weight:bold;background:green;">Calculate ETH value</a>
                                    </div>
                                </div>
                                ...
                                <div id="success"class="alert alert-success text-center font-weight-bold">Transfer <span class="btcworth"></span> ETH to the above wallet Address
                                    <br>
                                ...
                                <div class="form-group">
                                    <button class="btn btn-success text-center text-light">I have sent ETH </button>
                                </div>
                            </form>
                    </div>
                </div>
